...
public class VoiceService implements IVoiceService {
    ...
    public void postBurialPointEvent(String eventType, String triggerMode, long time, String extraStr) {
        ...
        TrackOther trackOther = new TrackOther(MegaDisplayHelper.getScreenTypeByMyUserHandle());
    ...
    public int getDisplayId() {
        return MegaDisplayHelper.getDisplayIdByMyUserHandle();
    }

    @Override
    public void sendBroadcastToGallery(Context context, Intent intent) {
        context.sendBroadcastAsUser(intent, MegaUserHandle.SYSTEM);
    }
    ...
    public Context getDisplayContext(Context context, int displayId) {
        ...
        Context contextDisplay = context;
        DisplayManager displayManager = context.getSystemService(DisplayManager.class);
        Display display = displayManager.getDisplay(displayId);
        if (display != null) {
            contextDisplay = context.createDisplayContext(display);
        }
