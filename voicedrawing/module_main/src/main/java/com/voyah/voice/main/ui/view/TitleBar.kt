...
import com.voyah.voice.main.databinding.LayoutTitleBarBinding
...
class TitleBar @JvmOverloads constructor(
    ...
    private var titleBarListener: TitleBarListener? = null
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        mBinding.llBackLayer.setStateAnimatorList()
    }
        ...
        for (i in 0 until count) {
            when (val attr = array.getIndex(i)) {
                ...
                R.styleable.TitleBar_middleTextSize -> {
                    ...
                    mBinding.tvMiddle.setTextSize(TypedValue.COMPLEX_UNIT_PX, size)
                }
                ...
                R.styleable.TitleBar_leftLayerPaddingLeft -> {
                    val paddingLeft = array.getDimension(attr, 0f)
                    Log.d("TitleBar", "setAttrs: paddingLeft:$paddingLeft")
                    mBinding.llBackLayer.setPadding(paddingLeft.toInt(), 0, 0, 0)
                }
    ...
    fun getLeftBackContainer(): View {
        return mBinding.llBackLayer
    }
