...
package com.voyah.voice.framework.toast
...
import com.voyah.voice.framework.databinding.WidgetTipsToastBinding
...
object TipsToast {
    ...
    fun showSuccessTips(msg: String?) {
        showTipsImpl(
            msg,
            Toast.LENGTH_SHORT,
            R.drawable.widget_toast_success
        )
    }
    ...
    fun showWarningTips(msg: String?) {
        showTipsImpl(
            msg,
            Toast.LENGTH_SHORT,
            R.drawable.widget_toast_warning
        )
    }
