    ...
    public int getBaseIntProp(String key, int area) {
        switch (key) {
            ...
            case ScreenSignal.SCREEN_LOCK_RL:
                return CarServicePropUtils.getInstance().getIntProp(H56D.ACP_RL_IVI_ACP_RL_LOCKSTA);
            case ScreenSignal.SCREEN_LOCK_RR:
                return CarServicePropUtils.getInstance().getIntProp(H56D.ACP_RR_IVI_ACP_RR_LOCKSTA);
    ...
    public void setBaseIntProp(String key, int area, int value) {
        switch (key) {
            ...
            case ScreenSignal.SCREEN_LOCK_STATE:
                CarServicePropUtils.getInstance().setIntProp(H56D.IVI_chassisSet2_IVI_ACPLRLOCK, value);
                break;
            case ScreenSignal.SCREEN_CEILING_ANGLE:
            ...
            case ScreenSignal.SCREEN_INSTRUMENT_AUTO:
                ...
                break;
            case ScreenSignal.SCREEN_LOCK_RL:
                CarServicePropUtils.getInstance().setIntProp(H56D.IVI_chassisSet3_IVI_ACPRLLOCKREQ, value);
                break;
            case ScreenSignal.SCREEN_LOCK_RR:
                CarServicePropUtils.getInstance().setIntProp(H56D.IVI_chassisSet3_IVI_ACPRRLOCKREQ, value);
                break;
            default:
