...
public class SunRoofHelper {
    ...
    public static int getSunRoofState() {
        LogUtils.e(TAG, "获取当前天窗的状态百分比：" + CarPropUtils.getInstance().getIntProp(H56D.GW_LIN_BODY_SRM_SRPOSITION, VehicleArea.OUTSIDE_TOP));
        return CarPropUtils.getInstance().getIntProp(H56D.GW_LIN_BODY_SRM_SRPOSITION, VehicleArea.OUTSIDE_TOP);
    }
