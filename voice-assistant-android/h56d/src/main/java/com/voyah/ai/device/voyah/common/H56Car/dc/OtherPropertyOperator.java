...
public class OtherPropertyOperator extends Base56Operator implements IDeviceRegister {

    @Override
    void init() {
//        map.put(OtherSignal.OTHER_STATIC_GESTURE_SWITCH, Dms.ID_GESTURE_RECOG_ONOFF);
//        map.put(OtherSignal.OTHER_DYNAMIC_GESTURE_SWITCH, Signal.ID_DYNAMIC_GESTURE_SWITCH);
    ...
    public boolean getBaseBooleanProp(String key, int area) {
        switch (key) {
            ...
            case OtherSignal.OTHER_NEWS_SWITCH:
                return SettingsManager.get().isEnableSwitch(DhSwitch.NewsPush);
            default:
    ...
    public void setBaseBooleanProp(String key, int area, boolean value) {
        switch (key) {
            ...
            case OtherSignal.OTHER_MULTI_ZONE_DIALOGUE:
                ...
                break;
            case OtherSignal.OTHER_NEWS_SWITCH:
                SettingsManager.get().enableSwitch(DhSwitch.NewsPush, value);
                break;
            default:
