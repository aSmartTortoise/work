...
public interface MusicApi {
    ...
    @Sync
    @Request("{sourceType}" + "/" + "mediamanagerbridgesm/getplaystate")
    SyncResponse<Integer> getPlayState(@Path("sourceType") String sourceType, @Param String source,@User UserHandle userHandle);
    ...
    /*******整车控制 目前仅56D使用*********/
    @Sync
    @Request("{sourceType}" + "/" + "multiusermediamanagersm/play")
    SyncResponse<Object> play(@Path("sourceType") String sourceType, @Param CmdTarget cmdTarget);

    @Sync
    @Request("{sourceType}" + "/" + "multiusermediamanagersm/prev")
    SyncResponse<Object> prev(@Path("sourceType") String sourceType, @Param CmdTarget cmdTarget);

    @Sync
    @Request("{sourceType}" + "/" + "multiusermediamanagersm/next")
    SyncResponse<Object> next(@Path("sourceType") String sourceType, @Param CmdTarget cmdTarget);

    @Sync
    @Request("{sourceType}" + "/" + "multiusermediamanagersm/pause")
    SyncResponse<Object> pause(@Path("sourceType") String sourceType,@Param UserHandle userHandle);
