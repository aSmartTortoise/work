...
public class SuspensionControlPropertyOperator extends Base56Operator implements IDeviceRegister {
    ...
    void init() {
        ...
        map.put(SuspensionSignal.SUSPENSION_ADJUSTABLE,H56D.ASC_state1_ASC_SUSTEMPUNADJUSTABLEREASON);//悬架是否可以调节

        map.put(SuspensionSignal.SUSPENSION_OUTINGMODE, Driving.ID_DRV_MODE);//郊游模式判断

        map.put(SuspensionSignal.SUSPENSION_RISING_FALLING,H56D.IVI_chassisSet_IVI_MANUALEASYOUTSW);//手动调节悬架  上升 下降

        map.put(SuspensionSignal.SUSPENSION_BOARDINGCAR,H56D.ASC_state1_ASC_AUTOEASYENTRYFB);//便捷上下车是否打开

        map.put(SuspensionSignal.SUSPENSION_HIGHSPEED,Driving.ID_DRV_HIGHWAY_MODE);//高速悬架自适应调节是否打开   打开关闭 高速悬架自适应调节

        map.put(SuspensionSignal.SUSPENSION_HEIGHTSPEEDADJUST,H56D.ASC_state1_ASC_SPEDAJUSTSETFB);//悬架高度随车速自动调节是否打开

        map.put(SuspensionSignal.SUSPENSION_LOADADJUST,H56D.ASC_state1_ASC_EASYPACKFB);//便捷载物是否打开

        map.put(SuspensionSignal.SUSPENSION_MAINTENANCEADJUST,Driving.ID_DRV_SUSPENSION_MAINTAIN);//悬架维修模式是否打开

        map.put(SuspensionSignal.SUSPENSION_DOINGCLOSEBOARDINGCAR,H56D.IVI_chassisSet_IVI_AUTOEASYENTRYSET);//打开 关闭 便捷上下车自动调节

        map.put(SuspensionSignal.SUSPENSION_DOINGHEIGHTSPEDCAR,H56D.IVI_chassisSet2_IVI_ASC_SPEDAJUSTSET);//打开关闭 悬架高度随车速自动调节


       map.put(SuspensionSignal.SUSPENSION_DOINGLOADADJUST,H56D.IVI_chassisSet2_IVI_EASYPACKSET);//打开关闭 便捷载物
