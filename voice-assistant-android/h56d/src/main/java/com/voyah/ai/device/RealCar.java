...
import com.voyah.ai.device.voyah.h37.dc.utils.H56DSettingInterfaceImpl;
...
public class RealCar {
    ...
    private static final IBuriedPointManager buriedPointManager = new BuriedPointManagerImp();
    ...
    public static void init(Context context) {
        ...
        DeviceHolder.INS().setDevicesInterface(new DevicesInterface() {
            ...
            public SettingInterface getSetting() {
                return H56DSettingInterfaceImpl.INSTANCE;
            }
