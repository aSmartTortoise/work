...
public class SeatHelper {
    ...
    public static void saveSeatPosition(int area, int value) {
        ...
        switch (area) {
            ...
            case VehicleArea.FRONT_RIGHT:
                key = H56D.IVI_SCUCtrl2_IVI_PSMSETMEMORYREQ;
                break;
            case VehicleArea.REAR_LEFT:
                key = H56D.IVI_BD_CFSet_IVI_2LSEATSETMEMORYREQ;
                break;
            case VehicleArea.REAR_RIGHT:
                key = H56D.IVI_BD_CFSet_IVI_2RSEATSETMEMORYREQ;
                break;
            default:
                key = -1;
                break;
    ...
    public static void setSeatPosition(int area, int value) {
        ...
        switch (area) {
            case VehicleArea.FRONT_LEFT:
                ...
                break;
            case VehicleArea.FRONT_RIGHT:
                key = H56D.IVI_SCUCtrl2_IVI_PSMGETMEMORYREQ;
                break;
            case VehicleArea.REAR_LEFT:
                key = H56D.IVI_BD_CFSet_IVI_2LSEATGETMEMORYREQ;
                break;
            case VehicleArea.REAR_RIGHT:
                key = H56D.IVI_BD_CFSet_IVI_2RSEATGETMEMORYREQ;
                break;
            default:
                key = -1;
                break;
    ...
    public static void setSeatMirrorSave(int area, int value) {
        CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl_IVI_DSMSETMEMORYREQ, value);
    }

    public static void setSeatMirrorRecovery(int area, int value) {
        CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl_IVI_DSMGETMEMORYREQ, value);
    }
    ...
    public static boolean isOccupied(int area) {
        int rightSTS1 = CarPropUtils.getInstance().getIntProp(H56D.ACU_state_ACU_PASSENGERSTS);
        int leftSTS2 = CarPropUtils.getInstance().getIntProp(H56D.ACU_state_ACU_SECONDLEFTSTS);
        int rightSTS2 = CarPropUtils.getInstance().getIntProp(H56D.ACU_state_ACU_SECONDRIGHTSTS);
        int leftSTS3 = CarPropUtils.getInstance().getIntProp(H56D.BCM_state3_BCM_3NDLEFTSTS);
        int rightSTS3 = CarPropUtils.getInstance().getIntProp(H56D.BCM_state3_BCM_3NDRIGHTSTS);
    ...
    public static void seatComfortablyStopMove(int area) {
        ...
        switch (area) {
            case PositionSignal.SECOND_ROW_LEFT:
                key = H56D.IVI_SCUCtrl_IVI_2LSEATPAUSE;
                break;
            case PositionSignal.SECOND_ROW_RIGHT:
                key = H56D.IVI_SCUCtrl_IVI_2RSEATPAUSE;
                break;
            default:
                key = -1;
                break;
    ...
    public static void setSeatState(int type, int area, int value) {
        ...
        if (Comforts.ID_SEAT_MASSAGE == type) {
            switch (area) {
                case VehicleArea.FRONT_LEFT:
                    writePropId = H56D.IVI_SCUCtrl2_IVI_FLSEATMASSONOFFSET;
                    break;
                case VehicleArea.FRONT_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl2_IVI_FRSEATMASSONOFFSET;
                    break;
                case VehicleArea.REAR_LEFT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_RLSEATMASSONOFFSET;
                    break;
                case VehicleArea.REAR_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_RRSEATMASSONOFFSET;
                    break;
            }
        } else if (Climate.ID_SEAT_VENT == type) {
            switch (area) {
                case VehicleArea.FRONT_LEFT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_DRSEATVENTONOFFSET;
                    break;
                case VehicleArea.FRONT_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_PASSSEATVENTONOFFSET;
                    break;
                case VehicleArea.REAR_LEFT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_RLSEATVENTONOFFSET;
                    break;
                case VehicleArea.REAR_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_RRSEATVENTONOFFSET;
                    break;
            }
        } else if (Climate.ID_SEAT_HEAT == type) {
            switch (area) {
                case VehicleArea.FRONT_LEFT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_DRSEATHEATONOFFSET;
                    break;
                case VehicleArea.FRONT_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_PASSSEATHEATONOFFSET;
                    break;
                case VehicleArea.REAR_LEFT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_RLSEATHEATONOFFSET;
                    break;
                case VehicleArea.REAR_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl_IVI_RRSEATHEATONOFFSET;
                    break;
                case VehicleArea.ROW_3_LEFT:
                    writePropId = H56D.IVI_SCUCtrl2_IVI_3LSEATHEATONOFFSET;
                    break;
                case VehicleArea.ROW_3_RIGHT:
                    writePropId = H56D.IVI_SCUCtrl2_IVI_3RSEATHEATONOFFSET;
                    break;
            }
        }
    ...
    public static int getZeroGravityState(int area) {
        if (area == PositionSignal.SECOND_ROW_LEFT) {
            return CarPropUtils.getInstance().getIntProp(H56D.SCU_RL_SCU_RL_2LSEATZEROGSTA);
        } else {
            return CarPropUtils.getInstance().getIntProp(H56D.SCU_RR_SCU_RR_2RSEATZEROGSTA);
        }
    }

    public static void setZeroGravityState(int area) {
        if (area == PositionSignal.SECOND_ROW_LEFT) {
            CarPropUtils.getInstance().setIntProp(H56D.SCU_RL_SCU_RL_2LSEATZEROGSTA,1);
        } else {
            CarPropUtils.getInstance().setIntProp(H56D.SCU_RR_SCU_RR_2RSEATZEROGSTA,1);
        }
    }
    ...
    public static void setSeatFold(int area, boolean value) {
        if (area == 4) {
            if (value) {
                //三排左折叠
                CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3LSEATFOLDSET, 1);
            } else {
                //三排左展开
                CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3LSEATUNFOLDSET, 1);
            }
        } else {
            if (value) {
                //三排右折叠
                CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3RSEATFOLDSET, 1);
            } else {
                //三排右展开
                CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3RSEATUNFOLDSET, 1);
            }
        }
    }

    public static void seatFoldStopAdjust(int area) {
        if (area == PositionSignal.THIRD_ROW_LEFT) {
            CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3LSEATPAUSE, 1);
        }
        if (area == PositionSignal.THIRD_ROW_RIGHT) {
            CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3RSEATPAUSE, 1);
        }
        if (area == PositionSignal.THIRD_ROW) {
            CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3LSEATPAUSE, 1);
            CarPropUtils.getInstance().setIntProp(H56D.IVI_SCUCtrl2_IVI_3RSEATPAUSE, 1);
        }
    }
    ...
    public static boolean getSeatUserState(int area) {
        if (area == PositionSignal.THIRD_ROW_LEFT) {
            return CarPropUtils.getInstance().getIntProp(H56D.BCM_state3_BCM_3NDLEFTSTS) == 1;
        } else if (area == PositionSignal.THIRD_ROW_RIGHT) {
            return CarPropUtils.getInstance().getIntProp(H56D.BCM_state3_BCM_3NDRIGHTSTS) == 1;
        } else {
            return CarPropUtils.getInstance().getIntProp(H56D.BCM_state3_BCM_3NDMIDDLESTS) == 1;
        }
    }

    public static int getSeatCurFoldPosition(int area) {
        if (area == PositionSignal.THIRD_ROW_LEFT) {
            return CarPropUtils.getInstance().getIntProp(H56D.SCU_TR_SCU_TR_3LSEATBACKPOS);
        } else {
            return CarPropUtils.getInstance().getIntProp(H56D.SCU_TR_SCU_TR_3RSEATBACKPOS);
        }
    }

    public static String getCurSeatMassageMode(int area) {
        int curMassageMode = CarPropUtils.getInstance().getIntProp(Comforts.ID_SEAT_MASSAGE_MODE, area);
        return getMassageModeString(curMassageMode);
    }

    public static void setCurSeatMassageMode(int area, String massageMode) {
        int setMassageMode = getMassageMode(massageMode);
        int config = MegaSystemProperties.getInt(MegaProperties.CONFIG_EQUIPMENT_LEVEL, -1);
        if (setMassageMode < 6) {
            CarPropUtils.getInstance().setIntProp(Comforts.ID_SEAT_MASSAGE_MODE, area, setMassageMode);
        } else {
            if (area == VehicleArea.ROW_2_LEFT || area == VehicleArea.ROW_2_RIGHT) {
                if (config == 4) {
                    // N3N4车型的二排左 支持1-8的模式
                    CarPropUtils.getInstance().setIntProp(Comforts.ID_SEAT_MASSAGE_MODE, area, setMassageMode);
                }
    ...
    public static void setMassageSwitch(int area, int value) {
        ...
        switch (area) {
            case PositionSignal.FIRST_ROW_LEFT:
                key = H56D.IVI_SCUCtrl2_IVI_FLSEATMASSONOFFSET;
                break;
            case PositionSignal.FIRST_ROW_RIGHT:
                key = H56D.IVI_SCUCtrl2_IVI_FRSEATMASSONOFFSET;
                break;
            case PositionSignal.SECOND_ROW_LEFT:
                key = H56D.IVI_SCUCtrl_IVI_RLSEATMASSONOFFSET;
                break;
            case PositionSignal.SECOND_ROW_RIGHT:
                key = H56D.IVI_SCUCtrl_IVI_RRSEATMASSONOFFSET;
                break;
            default:
                key = -1;
                break;
    ...
    public static int getMassageMode(String mode) {
        switch (mode) {
            case "body_relaxation":
                return 1;
            case "body_circulation":
                return 2;
            case "body_stretch":
                return 3;
            case "shoulder_stretch":
                return 4;
            case "backside_activation":
                return 5;
            case "waist_relaxation":
                return 6;
            case "waist_stretch":
                return 7;
            case "footrest_circulation":
                return 8;
            default:
                return 1;
        }
    ...
    public static String getMassageModeString(int mode) {
        switch (mode) {
            case 1:
                return "body_relaxation";
            case 2:
                return "body_circulation";
            case 3:
                return "body_stretch";
            case 4:
                return "shoulder_stretch";
            case 5:
                return "backside_activation";
            case 6:
                return "waist_relaxation";
            case 7:
                return "waist_stretch";
            case 8:
                return "footrest_circulation";
            default:
                return "body_relaxation";
        }
    }
