...
//        map.put(CarSettingSignal.CARSET_SAFE_SENSITIVE, Adas.ID_ADAS_MON_SENSITIVITY_SW);
        ...
        map.put(CarSettingSignal.CARSET_AUTO_WIPE_SENSITIVE, H56D.IVI_BodySet3_IVI_AUTOWIPER);
...
//        map.put(CarSettingSignal.CARSET_ELE_PARKING, VehicleMotion.ID_PARKING_BRAKE_EPB);
        ...
        map.put(CarSettingSignal.CARSET_LOCK_UNLOCK_VOICE, H56D.IVI_BodySet2_IVI_LOCKTIPSSET);
        ...
        map.put(CarSettingSignal.CARSET_RM_AUTO_DOWN, H56D.IVI_BodySet2_IVI_RVMIRRORAUTOTURNDOWNSET);
        map.put(CarSettingSignal.CARSET_HIGH_BEAM_ASSIST, H56D.MPC3_IHBC_SYSS_FEEDBACK);
        map.put(CarSettingSignal.CARSET_INTERIOR_LIGHT_AUTO_DOME, H56D.IVI_BodySet1_IVI_ITLTOPLAMPREQ);
//        map.put(CarSettingSignal.CARSET_CHARGE_LIGHT_EFFECT, Signal.ID_CHARGE_LIGHT_EFFECT_SETTING);
        ...
        map.put(CarSettingSignal.CARSET_REAR_BADGE_LIGHTS, H56D.IVI_BodySet3_IVI_REARLOGOLAMPSET);// 执行打开/关闭后车标灯
        map.put(CarSettingSignal.CARSET_REAR_BADGE_LIGHTS_STATE, H56D.BCM_state4_BCM_REARLOGOLAMPSTA);//后车标灯的状态
        map.put(CarSettingSignal.CARSET_UNABLE_WINDOW_SWITCH, H56D.IVI_BodySet2_IVI_REARWINDOWLOCKCTRL);//后排车窗禁用开关
//        map.put(CarSettingSignal.CARSET_UNABLE_WINDOW_SWITCH_LEFT,H56D.DCU_RL_DCU_RL_RLWINDOWLOCKSTS);//左侧后排车窗禁用是否打开
//        map.put(CarSettingSignal.CARSET_UNABLE_WINDOW_SWITCH_RIGHT,H56D.DCU_RR_DCU_RR_RRWINDOWLOCKSTS);//右侧后排车窗禁用是否打开

        map.put(CarSettingSignal.CARSET_DOOR_STATE, EntryLocks.ID_DOOR);//车门状态

        map.put(CarSettingSignal.CARSET_DOOR_FRONTLEFT, H56D.GW_DCU_state_DCU_FL_DOORFLSTS_0X27E);//左前车门
        map.put(CarSettingSignal.CARSET_DOOR_FRONTRIGHT, H56D.GW_DCU_state_DCU_FR_DOORFRSTS_0X27E);//右前车门
        map.put(CarSettingSignal.CARSET_DOOR_REARLEFT, H56D.PSD_L_PSD_L_RLDOOR_ST);//左后车门
        map.put(CarSettingSignal.CARSET_DOOR_REARRIGHT, H56D.PSD_R_PSD_R_RRDOOR_ST);//右后车门

        map.put(CarSettingSignal.CARSET_DISABLE_MODE, H56D.PDCM_IVI_PDCM_EXHIBITIONSTS);//获取是否处于Disable模式
    ...
    public boolean getBaseBooleanProp(String key, int area) {
        switch (key) {
            ...
            case CarSettingSignal.CARSET_DOOR_FRONTLEFT:
                return CarPropUtils.getInstance().getIntProp(H56D.GW_DCU_state_DCU_FL_DOORFLSTS_0X27E) == 1;
            case CarSettingSignal.CARSET_DOOR_FRONTRIGHT:
                return CarPropUtils.getInstance().getIntProp(H56D.GW_DCU_state_DCU_FR_DOORFRSTS_0X27E) == 1;
            case CarSettingSignal.CARSET_DOOR_REARLEFT:
                return CarPropUtils.getInstance().getIntProp(H56D.PSD_L_PSD_L_RLDOOR_ST) == 1;
            case CarSettingSignal.CARSET_DOOR_REARRIGHT:
                return CarPropUtils.getInstance().getIntProp(H56D.PSD_R_PSD_R_RRDOOR_ST) == 1;
