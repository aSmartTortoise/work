...
public class WindowHelper {
    ...
    public static void setWindow(int area, int value) {
        try {
            ...
            //1696452610   Signal.ID_HMIR_WIMDOWPCTCMD   H56C.IVI_BodySet4_IVI_FRWINDOWHORIZONTALREQ
            ...
            switch (area) {
                ...
                case PositionSignal.FIRST_ROW_RIGHT:
                    jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_FRWINDOWHORIZONTALREQ, object.toString());//副驾
                    break;
                case PositionSignal.SECOND_ROW_LEFT:
                case PositionSignal.THIRD_ROW_LEFT:
                    jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_RLWINDOWHORIZONTALREQ, object.toString());//二排左
                    break;
                case PositionSignal.SECOND_ROW_RIGHT:
                case PositionSignal.THIRD_ROW_RIGHT:
                    jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_RRWINDOWHORIZONTALREQ, object.toString());//二排右
                    break;
                default:
                    jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_FLWINDOWHORIZONTALREQ, object.toString());//默认是主驾
                    break;
            ...
            Logger.d("--------------"+H56C.IVI_BodySet4_IVI_FLWINDOWHORIZONTALREQ,"==================");
    ...
    public static void setWindow(int area,String value) {
        ...
        switch (area+"") {
            case "0":
//                jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_FLWINDOWHORIZONTALREQ, value);//默认是主驾
                CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet4_IVI_FLWINDOWHORIZONTALREQ,Integer.parseInt(value));
                break;
            case "1":
//                jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_FRWINDOWHORIZONTALREQ, value);//副驾
                CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet4_IVI_FRWINDOWHORIZONTALREQ,Integer.parseInt(value));
                break;
            case "4":
            case "2":
//                jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_RLWINDOWHORIZONTALREQ, value);//二排左
                CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet4_IVI_RLWINDOWHORIZONTALREQ,Integer.parseInt(value));
                LogUtils.i(TAG, "setWindow :area======" + area);
                break;
            case "5":
            case "3":
//                jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_RRWINDOWHORIZONTALREQ, value);//二排右
                CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet4_IVI_RRWINDOWHORIZONTALREQ,Integer.parseInt(value));
                LogUtils.i(TAG, "setWindow :area======" + area);
                break;
            default:
//                jsons = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_FLWINDOWHORIZONTALREQ, value);//默认是主驾
...
//        CarPropertyValue<String> json = new CarPropertyValue<>(H56C.IVI_BodySet4_IVI_FLWINDOWHORIZONTALREQ, value);
//        CarPropUtils.getInstance().setRawProp(jsons);
    }
