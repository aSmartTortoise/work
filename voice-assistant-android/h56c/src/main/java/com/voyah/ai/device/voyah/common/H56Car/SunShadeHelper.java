...
public class SunShadeHelper {
    ...
    public static int getSunShadeState() {
        return CarPropUtils.getInstance().getIntProp(H56C.GW_LIN_INFO_SSM_SSPOSITION, VehicleArea.OUTSIDE_TOP);
    }

    public static void setSunShadeState(int value) {
//        CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet1_IVI_SUNROOFROLLSHADECTRLSELECT, VehicleArea.OUTSIDE_TOP, 2);//1是天窗，2是遮阳帘
