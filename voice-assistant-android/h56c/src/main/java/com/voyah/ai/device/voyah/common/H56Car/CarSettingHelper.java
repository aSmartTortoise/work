...
public class CarSettingHelper {
    ...
    public static int getAutoParking() {
        return CarPropUtils.getInstance().getIntProp(H56C.IPB7_IPB_AVHMODEWSTS);
    }
    ...
    public static void setAutoParking(int value) {
        ...
        CarPropUtils.getInstance().setIntProp(H56C.IVI_chassisSet_IVI_AVHMODESET, valueToSet);
    }
    ...
    public static void setChildLockStatus(int onOff) {
        CarPropUtils.getInstance().setIntProp(EntryLocks.ID_LOCKS_CHILD_SEC_DOOR_LOCK, VehicleArea.ALL,
                onOff == Switch.OFF ? 7 : 8);
    }

    public static int getBackupRmAutoDown() {
        //1226 倒车后视镜获取状态值和设置状态值信号不同
        return CarPropUtils.getInstance().getIntProp(H56C.DCU_FL1_DCU_FL_MIRRORAUTOTURNDOWNSTS);
    }
...
//        return state == ONOFFSTS_INVALID;
    ...
    public static void setBTAutoUnlock(boolean value) {
        ...
        } else if (CarServicePropUtils.getInstance().isH56C()) {
            //56C  0x1: ACTIVE  0x2: INACTIVE
            CarPropUtils.getInstance().setIntProp(EntryLocks.ID_LOCKS_MODE_APPROACH_UNLOCK,
                    value ? 1 : 2);
        }
    }
    ...
    public static int getWipeStateSensitive() {
        int value = CarPropUtils.getInstance().getIntProp(H56C.BCM_state4_BCM_AUTOWIPERSTA);
        return value;
    }

    public static void setWipeStateSensitive(int value) {
        CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet3_IVI_AUTOWIPER, value);
    }
    ...
    public static boolean getWhistleLockStatus() {
        return CarPropUtils.getInstance().getIntProp(H56C.BCM_state4_BCM_LOCKTIPSSTS) == ParamsCommon.OnOffInvalid.ON;
    }

    public static void setWhistleLockStatus(boolean value) {
        CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet2_IVI_LOCKTIPSSET, value ? ICommon.Switch.ON : ICommon.Switch.OFF);
    }
    ...
    public static boolean getBackupRmAutoDownStatus() {
        return CarPropUtils.getInstance().getIntProp(H56C.DCU_FL1_DCU_FL_MIRRORAUTOTURNDOWNSTS) == 1;
    }

    public static void setBackupRmAutoDownStatus(boolean value) {
        CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet2_IVI_RVMIRRORAUTOTURNDOWNSET, value ? 2 : 1);
    }

    public static boolean getPositionLightsFollowDrlStatus() {
        return CarPropUtils.getInstance().getIntProp(H56C.BCM_state4_BCM_REARPOSITIONLAMPFOLLOW) == 0;
    }

    public static void setPositionLightsFollowDrlStatus(boolean value) {
        CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet3_IVI_REARPOSITIONLAMPFOLLOWSET, value ? 1 : 2);
    }

    public static boolean getIntelligentHighBeamAssistStatus() {
        return CarPropUtils.getInstance().getIntProp(H56C.MPC3_IHBC_SYSS_FEEDBACK) == 1;
    }

    public static void setIntelligentHighBeamAssistStatus(boolean value) {
        CarPropUtils.getInstance().setIntProp(H56C.IVI_icmSet_IHBC_MAINSWITCH, value ? 1 : 2);
    }

    public static boolean getTopLightsAutoTurnOnStatus() {
        return CarPropUtils.getInstance().getIntProp(H56C.BCM_state2_BCM_DOORLIGHTCTRLFB) == 1;
    }

    public static void setTopLightsAutoTurnOnStatus(boolean value) {
        CarPropUtils.getInstance().setIntProp(H56C.IVI_BodySet2_IVI_DOORLIGHTCTRL, value ? 1 : 2);
    }
