...
public class FragrancePropertyOperator extends Base56Operator implements IDeviceRegister {
    ...
    void init() {
        ...
        //香氛开关
        map.put(FragranceSignal.FRAGRANCE_SWITCH_STATE, H56C.BCM_FCM_BCM_FCM_FCMSWSET);
        //香氛等级
        map.put(FragranceSignal.FRAGRANCE_LEVEL, H56C.BCM_FCM_BCM_FCM_FRAGCONCENTRATIONRESP);
        //当前香氛是什么
        map.put(FragranceSignal.FRAGRANCE_MODE, H56C.BCM_FCM_BCM_FCM_FRAGTASTE);
        //香氛时长
    ...
    public String getBaseStringProp(String key, int area) {
        ...
        switch (key) {
            case FragranceSignal.FRAGRANCE_SLOT_TYPE:
                int slot1 = carPropHelper.getIntProp(H56C.BCM_FCM_BCM_FCM_CH1_TYPE);
                int slot2 = carPropHelper.getIntProp(H56C.BCM_FCM_BCM_FCM_CH2_TYPE);
                int slot3 = carPropHelper.getIntProp(H56C.BCM_FCM_BCM_FCM_CH3_TYPE);
...
//                }
    ...
    public void setBaseStringProp(String key, int area, String value) {
        ...
        switch (key) {
            case FragranceSignal.FRAGRANCE_MODE:
                curKey = H56C.IVI_BodySet3_IVI_FRAGTASTE;
                //当前香氛槽位index+1
                //[0,1,2]原始的
                //[1,2,3]传入的
                //获取原来香氛的数组
                ...
                break;
            case FragranceSignal.FRAGRANCE_LEVEL:
                curKey = H56C.IVI_BodySet3_IVI_FRAGCONCENTRATIONREQ;
    ...
    public void setBaseBooleanProp(String key, int area, boolean value) {
        ...
        switch (key) {
            case FragranceSignal.FRAGRANCE_SWITCH_STATE:
                resKey = H56C.IVI_BodySet3_IVI_FCMSWIRESP;
