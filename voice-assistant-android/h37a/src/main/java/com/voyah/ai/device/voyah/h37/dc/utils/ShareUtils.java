...
public class ShareUtils implements ShareInterface {
    ...
    private DlnaServiceImpl mDlnaServiceImpl;
    ...
    public ShareUtils() {
        ...
        mDlnaServiceImpl = DlnaServiceImpl.getInstance(ContextUtils.getAppContext());
        mDlnaServiceImpl.startService(serviceConnectionCallback);
    }
    ...
    public boolean openDlnaState(String targetScreen) {
        int result = mIVoyahShareConnectManager.openVoyahShare(VoyahShareServiceConnectManager.OPEN_TYPE_DLNA);
        LogUtils.d(TAG, "openDlna result = " + result);
        return true;
    }
    ...
    public boolean getDlnaState(String targetScreen,boolean onOff) {
        ...
        LogUtils.i(TAG, "getDlnaState dlnaState : " + dlnaState);
        return dlnaState == 0;
    }
