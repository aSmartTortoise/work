...
import com.voyah.ai.device.voyah.h37.dc.utils.H37ASettingInterfaceImpl;
import com.voyah.ai.device.voyah.h37.dc.utils.H37BSettingInterfaceImpl;
    ...
    public static void init(Context context) {
        ...
        DeviceHolder.INS().setDevicesInterface(new DevicesInterface() {
            ...
            public SettingInterface getSetting() {
                if (getCarServiceProp().isH37A()) {
                    return H37ASettingInterfaceImpl.INSTANCE;
                } else if (getCarServiceProp().isH37B()) {
                    return H37BSettingInterfaceImpl.INSTANCE;
                } else {
