...
@ClassAgent
public class NaviFavoritesSwitchSelectAgent extends AbstractNaviAgent {
    @Override
    public String AgentName() {
        return "navi_favorites_switch#select";
    }
    ...
    public ClientAgentResponse executeSyncNaviAgent(Map<String, Object> flowContext, Map<String, List<Object>> paramsMap) {
        ...
        return NaviPoiUtils.favoriteAddress(flowContext, poi);
    }
