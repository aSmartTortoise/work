...
@ClassAgent
public class MediaJumpAgent extends BaseAgentX {

    private static final String TAG = MediaJumpAgent.class.getSimpleName();
    ...
    public ClientAgentResponse executeAgent(Map<String, Object> flowContext, Map<String, List<Object>> paramsMap) {
        LogUtils.i(TAG, "-----run--MediaJumpAgent------");
...
//        String jumpType = getParamKey(paramsMap, Constant.JUMP_TYPE, 0);
        TTSBean tts = DeviceHolder.INS().getDevices().getMedia().jump();
//        if (tts == null) {
