...
@ClassAgent
public class NaviPoiDirectNavigationAgent extends AbstractNaviAgent {

    @Override
    public String AgentName() {
        return "navi_poi#direct_navigation";
    }
    ...
    public ClientAgentResponse executeSyncNaviAgent(Map<String, Object> flowContext, Map<String, List<Object>> paramsMap) {
        return NaviPoiUtils.searchPoi(flowContext, paramsMap, true);
    }
