...
@ClassAgent
public class NaviViaPointFavoriteSelectAgent extends AbstractNaviAgent {
    @Override
    public String AgentName() {
        return "navi_via_point_favorite#select";
    }
    ...
    public ClientAgentResponse executeSyncNaviAgent(Map<String, Object> flowContext, Map<String, List<Object>> paramsMap) {
        List<Poi> poiList = DeviceHolder.INS().getDevices().getNavi().getNaviViaPoint().getViaPoints();
        ...
        return NaviFavoriteUtils.favoritePoi(flowContext, poiList.get(index));
    }
