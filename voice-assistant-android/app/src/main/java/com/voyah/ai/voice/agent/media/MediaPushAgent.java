...
@ClassAgent
public class MediaPushAgent extends BaseAgentX {

    private static final String TAG = MediaPushAgent.class.getSimpleName();

    @Override
    public String AgentName() {
        return "media_push#switch";
    }
    ...
    public ClientAgentResponse executeAgent(Map<String, Object> flowContext, Map<String, List<Object>> paramsMap) {
        ...
        DeviceHolder.INS().getDevices().getMediaCenter().pushScreenToDisplay(sourceDisplayId,targetDisplayId,isSoundLocation);
