...
//    public static final String PARAMS_INVALID_COUNT = FlowContextKey.SC_KEY_PFREFIX + "invalidCount";
    ...
    public static final String NUMBER_RATE = "number_rate";
    ...
    public static final String SRC_SCREEN = "src_screen";
    public static final String DST_SCREEN = "dst_screen";
    public static final String DST_POSITION = "dst_position";
    ...
    public static final String MEDIA_SCREEN = "screen_name";
