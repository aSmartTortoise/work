 ...
 *  author : jie wang
 *  date : 2024/3/8 16:23
 *  description : 副驾屏 vpa、typewriter、card 悬浮窗 的holder。
 */
class PassengerScreenWindowHolder(context: Context): BaseVTCWindowHolder(context) {

    override fun getCardWindowTag() = WindowType.WINDOW_TYPE_CARD_PASSENGER_SCREEN

    override fun getVPATypeWindowTag() = WindowType.WINDOW_TYPE_VPA_TYPE_PASSENGER_SCREEN

    override fun getDisplayId(): Int {
        val voiceDisplayId = MegaDisplayHelper.getVoiceDisplayId(VoiceLocation.FRONT_RIGHT)
        LogUtils.d("getDisplayId voiceDisplayId:$voiceDisplayId")
        return voiceDisplayId
    }
        ...
        EasyFloat.with(context)
            ...
            .registerCallback {
                ...
                outsideTouch { _, _ ->
                    ...
                    CardDataRepo.remove(ScreenType.PASSENGER)
    ...
    override fun showVAWindow() {
        ...
        EasyFloat.with(context)
            ...
            .registerCallback {
                ...
                dismiss {
                    LogUtils.d("vpa type window dismiss.")
