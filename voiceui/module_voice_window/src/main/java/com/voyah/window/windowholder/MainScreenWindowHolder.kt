 ...
 */
class MainScreenWindowHolder(context: Context): BaseVTCWindowHolder(context) {

    override fun getCardWindowTag() = WindowType.WINDOW_TYPE_CARD_MAIN_SCREEN

    override fun getVPATypeWindowTag() = WindowType.WINDOW_TYPE_VPA_TYPE_MAIN_SCREEN

    override fun getDisplayId() = MegaDisplayHelper.getVoiceDisplayId(VoiceLocation.FRONT_LEFT)
