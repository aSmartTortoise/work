...
import com.voyah.cockpit.window.model.Result;
...
public class BundleUtil {
    ...
    public static Result toResult(Bundle bundle) {
        if (bundle == null) {
            return new Result();
        }
        Result result = new Result();
        result.setCode(bundle.getInt("code"));
        result.setMessage(bundle.getString("message"));
        result.setResult(bundle.get("result"));
        return result;
    }
